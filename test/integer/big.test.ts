...
describe('Integer', function() {
	describe('BigInteger', function() {
		describe('add', function() {
			it('1 + 1 = 2', function() {
				const a = BigInteger.fromNumber(1);
				const b = BigInteger.fromNumber(1);
				const r = add(a, b);
		...
		describe('multiply', function() {
			it('2 * 4 = 8', function() {
				const a = BigInteger.fromNumber(2);
				const b = BigInteger.fromNumber(4);
		...
		describe('divide', function() {
			it('4 / 2 = 2', function() {
				const a = BigInteger.fromNumber(4);
				const b = BigInteger.fromNumber(2);
				const r = divide(a, b);
				expect(r.toString()).toEqual('2');
			});
		});
		...
		describe('unaryMinus', function() {
			it('-5', function() {
				const a = BigInteger.fromNumber(5);
