...
describe('Decimal', function() {
	describe('Big', function() {
		describe('add', function() {
			it('1 + 1 = 2', function() {
				const a = BigDecimal.fromNumber(1);
				const b = BigDecimal.fromNumber(1);
				const r = add(a, b);
				expect(r.toString()).toEqual('2');
			});

			it('1.2 + 1 = 2.2', function() {
				const a = BigDecimal.fromNumber(1.2);
				const b = BigDecimal.fromNumber(1);
				const r = add(a, b);
			...
			it('1 + 1.2 = 2.2', function() {
				const a = BigDecimal.fromNumber(1);
				const b = BigDecimal.fromNumber(1.2);
				const r = add(a, b);
				expect(r.toString()).toEqual('2.2');
			});
			...
			it('1.8 + 1.2 = 3.0', function() {
				const a = BigDecimal.fromNumber(1.8);
				const b = BigDecimal.fromNumber(1.2);
				const r = add(a, b);
			...
			it('1.08 + 1.02 = 2.1', function() {
				const a = BigDecimal.fromNumber(1.08);
				const b = BigDecimal.fromNumber(1.02);
				const r = add(a, b);
		...
		describe('subtract', function() {
			it('2 - 1 = 1', function() {
				const a = BigDecimal.fromNumber(2);
				const b = BigDecimal.fromNumber(1);
		...
		describe('multiply', function() {
			...
			it('2.2 * 4 = 8.8', function() {
				const a = BigDecimal.fromNumber(2.2);
				const b = BigDecimal.fromNumber(4);
				const r = multiply(a, b);
				expect(r.toString()).toEqual('8.8');
			});

			it('12 * 0.1 = 1.2', function() {
				const a = BigDecimal.fromNumber(12);
				const b = BigDecimal.fromNumber(0.1);
				const r = multiply(a, b);
		...
		describe('divide', function() {
			it('4 / 2 = 2', function() {
				const a = BigDecimal.fromNumber(4);
				const b = BigDecimal.fromNumber(2);
				const r = divide(a, b, { roundingMode: RoundingMode.Down });
				expect(r.toString()).toEqual('2');
			});

			it('5 / 2 = 2.5', function() {
				const a = BigDecimal.fromNumber(5);
				const b = BigDecimal.fromNumber(2);
				const r = divide(a, b, { roundingMode: RoundingMode.Down });
		...
		describe('compare', function() {
			...
			it('0 == 0', function() {
				const a = BigDecimal.fromNumber(0);
				const b = BigDecimal.fromNumber(0);
